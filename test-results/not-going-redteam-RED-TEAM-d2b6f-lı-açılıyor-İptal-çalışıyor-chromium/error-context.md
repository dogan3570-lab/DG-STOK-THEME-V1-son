...
- Name: not-going-redteam.spec.ts >> RED TEAM — Pazaryerine Gitmeyen Modülü >> RT-07: Tek ürün "Çıkar" modalı açılıyor + İptal çalışıyor
- Location: tests\not-going-redteam.spec.ts:215:3
