...
- Name: not-going-redteam.spec.ts >> RED TEAM — Pazaryerine Gitmeyen Modülü >> RT-13: Yenile butonu listeyi tazeler
- Location: tests\not-going-redteam.spec.ts:377:3

# Error details

```
Error: getUiXmlSourceId: 30000ms içinde ID alınamadı. Denemeler: [status=0 ct= id=empty | status=0 ct= id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=401 ct=application/json; charset=utf-8 id=empty | status=0 ct= id=empty | status=0 ct= id=empty | status=0 ct= id=empty | status=401 ct=application/json; charset=utf-8 id=empty]
```
